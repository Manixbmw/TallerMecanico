...
namespace di.proyecto.clase.Servicios
{
        ...
        where T : class
    {
        ...
        ///<summary>
        /// El método lanza la sentencia SQL a la base de datos y recupera la informacion
        /// en forma de lista de entidades
        /// Está pénsado para que devuelva una entidad ,NO PARA HACER JOINS
        /// </summary>
        ///	<param name="sql">sentencia SQL </param>
        /// <returns>Lista con las entidades que devuelve la sentencia SQL</return>
